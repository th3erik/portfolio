...
export const Whoami = () => {
  ...
  const description = [
    'I am a seasoned professional with a wealth of experience in crafting cutting-edge web applications and digital solutions over the past five years as a Software Engineer.',
